...
- [ ] **19. Урчны түүх — "Гар урчинтай танилц"** — Дэлгүүрт banner + дэлгэрэнгүй түүх + workshop зураг ("Би хэн бэ", ажлын явц). Гар урлалын ялгарал. (`sellers`-д `banner_path`, `story`). — **M**
